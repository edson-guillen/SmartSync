...
{
    public class DispositivoService(IDispositivoRepository repository, IRabbitMqPublisher publisher) : BaseService<Dispositivo>(repository, publisher), IDispositivoService
    {
    }
}
